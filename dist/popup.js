...
function initBranchInput() {
  chrome.storage.local.get([PROJECT_BRANCH_KEY], function (data) {
    var projectBranch = data[PROJECT_BRANCH_KEY];
    var branchInputEl = document.querySelector('#branch-input');
...
function initBranchButtons() {
  var confirmButtonEl = document.querySelector('#confirm');
...
function confirmInput() {
  var branchInputEl = document.querySelector('#branch-input');
  var branchValue = branchInputEl.value;
  setBranch(branchValue);
}

function setBranch(branchValue) {
  return new Promise(function (resolve) {
    chrome.storage.local.set(_defineProperty({}, PROJECT_BRANCH_KEY, branchValue), function () {
