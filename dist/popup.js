...
function getBranch(branchKey) {
  return new Promise(function (resolve) {
    chrome.storage.local.get([branchKey], function (data) {
      var branch = data[branchKey] || null;
      resolve(branch);
    });
  });
}
function setBranch(branchKey, branchValue) {
  return new Promise(function (resolve) {
    chrome.storage.local.set(_defineProperty({}, branchKey, branchValue), function () {
...
function BranchSetting() {
  var _useState = react.useState(initialForm),
      _useState2 = _slicedToArray(_useState, 2),
      form = _useState2[0],
      setForm = _useState2[1];

  useDidMount(function () {
    getBranch(PROJECT_BRANCH_KEY).then(function (projectBranch) {
  ...
  var onConfirmClick = function onConfirmClick() {
    setBranch(PROJECT_BRANCH_KEY, form.projectBranch);
  };

  var onResetClick = function onResetClick() {
    setBranch(PROJECT_BRANCH_KEY, null);
  };

  var onProjectBranchChange = function onProjectBranchChange(e) {
    setForm(_objectSpread2(_objectSpread2({}, form), {}, {
      projectBranch: e.target.value
    }));
  };

  return /*#__PURE__*/react.createElement("section", null, /*#__PURE__*/react.createElement("div", null, "\u81EA\u5B9A\u4E49\u5206\u652F", /*#__PURE__*/react.createElement("input", {
    value: form.projectBranch,
    onChange: onProjectBranchChange
...
function App() {
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(BranchSetting, null));
}
